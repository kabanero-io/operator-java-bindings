...
public class StackList {
  ...
  private List<Stack> items = new ArrayList<Stack>();
  ...
  **/
  ...
  public StackList items(List<Stack> items) {
    
    this.items = items;
    return this;
  }

  public StackList addItemsItem(Stack itemsItem) {
    this.items.add(itemsItem);
    return this;
  }

   /**
   * List of stacks. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
   * @return items
  **/
  @ApiModelProperty(required = true, value = "List of stacks. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md")
  ...
  public StackList kind(String kind) {
