...
public class Stack {
  ...
  public Stack apiVersion(String apiVersion) {
  ...
  **/
  ...
  public Stack metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public Stack spec(StackSpec spec) {
  ...
  **/
  ...
  public StackSpec getSpec() {
    return spec;
  }


  public void setSpec(StackSpec spec) {
    this.spec = spec;
  }


  public Stack status(StackStatus status) {
