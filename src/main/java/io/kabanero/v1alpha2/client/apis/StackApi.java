...
public class StackApi {
     ...
     * @throws ApiException Thrown if an error occurred while communicating with the Kubernetes API server.
     */
    public V1Status deleteStack(String namespace, String name, V1DeleteOptions body, Integer gracePeriodSeconds, Boolean orphanDependents, String propagationPolicy) throws ApiException {
    	if (namespace == null) {
    		throw new IllegalArgumentException("namespace must not be null");
    	}
    	if (name == null) {
